...
namespace Identity.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Stores the token from facebook into the db for future use.
        private async Task StoreFacebookAuthToken(ApplicationUser user)
        {
            ...
            if (claimsIdentity != null)
            {
                ...
                {
                    //See if the stored token matches the new token.
                    //If the user has removed the facebook app, we need to save a new token
